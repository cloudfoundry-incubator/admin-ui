      ...
      @caches =
        {
          ...
          quota_definitions:
          {
            ...
            columns: [:app_instance_limit, :app_task_limit, :created_at, :guid, :id, :instance_memory_limit, :memory_limit, :name, :non_basic_services_allowed, :total_private_domains, :total_routes, :total_services, :updated_at]
          },
          routes:
          {
            db_uri:  ccdb_uri,
          ...
          space_quota_definitions:
          {
            ...
            columns: [:app_instance_limit, :app_task_limit, :created_at, :guid, :id, :instance_memory_limit, :memory_limit, :name, :non_basic_services_allowed, :organization_id, :total_routes, :total_services, :updated_at]
          },
          spaces:
          {
            db_uri:  ccdb_uri,
