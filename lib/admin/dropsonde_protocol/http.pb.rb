...
module Events
  ...
  set_option :java_outer_classname, "HttpFactory"
  ...
  class HttpStartStop
    ...
    required ::Events::UUID, :requestId, 3
    required ::Events::PeerType, :peerType, 4
    required ::Events::Method, :method, 5
    ...
    optional ::Events::UUID, :applicationId, 12
