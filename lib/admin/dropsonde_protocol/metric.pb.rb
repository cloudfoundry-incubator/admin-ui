...
module Events
  ...
  ::Protobuf::OPTIONS[:"java_outer_classname"] = "MetricFactory"
  require 'uuid.pb'
  class ValueMetric < ::Protobuf::Message
    defined_in __FILE__
    required :string, :name, 1
    required :double, :value, 2
    required :string, :unit, 3
  end
  class CounterEvent < ::Protobuf::Message
    defined_in __FILE__
    required :string, :name, 1
    required :uint64, :delta, 2
    optional :uint64, :total, 3
  end
  class ContainerMetric < ::Protobuf::Message
    defined_in __FILE__
