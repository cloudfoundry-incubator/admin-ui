...
<head>
	...
	<title>DataTables example - Date rendering (Moment.js)</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>Date rendering (Moment.js)</span></h1>
			<div class="info">
				<p>Often you might use ISO8601 as the format to transmit data on the wire, but it isn't the most friendly format to show an end user. For that reason, DataTables
				provides a <code>datetime</code> rendering helper which can be used to transform dates and time formats. With a single argument, as shown here, it will read the
				original data as ISO8601 and then display in the format given.</p>
