...
<head>
	...
	<title>DataTables example - ISO8601 detection</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>ISO8601 detection</span></h1>
			<div class="info">
				<p>DataTables supports ordering of ISO8601 date / time formats without any additional configuration. The <em>Start date</em> column in the example below shows
				this. Click on the column header to sort chronologically.</p>
			</div>
			<div class="demo-html">
