...
<head>
	...
	<title>DataTables example - Ordering formatted dates (Luxon)</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>Ordering formatted dates (Luxon)</span></h1>
			<div class="info">
				<p>As with the other date / time examples, the detection of date / time formats operates the same way for Luxon (shown here) as it does for Moment.js. They each
				have their own formatting options - for the full range of Luxon formatting options please see the <a href=
				"https://moment.github.io/luxon/#/formatting?id=table-of-tokens">Luxon documentation</a>.</p>
			</div>
			<div class="demo-html">
