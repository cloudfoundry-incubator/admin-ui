...
<head>
	...
	<title>DataTables example - Format transform (Luxon)</title>
	...
	<script type="text/javascript" language="javascript" src="https://cdnjs.cloudflare.com/ajax/libs/luxon/2.3.1/luxon.min.js"></script>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>Format transform (Luxon)</span></h1>
			<div class="info">
				<p>This example shows the same <a href="transform-moment.html">transform abilities</a> as the Moment.js example, but in this case using the Luxon date/time
				library. The <code>datetime</code> API is identical so it takes three parameters:</p>
				<ol class="markdown">
					<li>The original date format (please note that the parser is strict - you must exactly match the data format)</li>
					<li>The format you want to display</li>
					<li>The locale - used for internationalisation.</li>
				</ol>
				<p>Note however, although the API is identical, Luxon's formatting tokens are different from Moment.js'. For the full range of Luxon formatting options please see
				the <a href="https://moment.github.io/luxon/#/formatting?id=table-of-tokens">Luxon documentation</a>.</p>
				<p>See <a href="https://datatables.net/manual/data/renderers#Built-in-helpers">the renderers documentation</a> for full details about the renderers available in
				DataTables.</p>
			</div>
			<div class="demo-html">
		...
		columnDefs: [
			{
				...
				render: DataTable.render.datetime('d MMM yyyy', 'MMM d, yy', 'en'),
					...
					<ul>
						...
						<li>
							<a href="https://cdnjs.cloudflare.com/ajax/libs/luxon/2.3.1/luxon.min.js">https://cdnjs.cloudflare.com/ajax/libs/luxon/2.3.1/luxon.min.js</a>
						</li>
						<li>
