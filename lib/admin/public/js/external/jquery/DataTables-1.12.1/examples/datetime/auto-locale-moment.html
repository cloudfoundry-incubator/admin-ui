...
<head>
	...
	<title>DataTables example - Auto-locale display (Luxon)</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>Auto-locale display (Luxon)</span></h1>
			<div class="info">
				<p>DataTables provides renders that can automatically format ISO8601 date, datetime and time formats into a human readable format, in a format suitable for the
				user's locale settings. This means you don't need to worry about where your users are in the world - for example a user in USA might expect to see M/D/Y, while in
				Europe D/M/Y is used.</p>
				<p>This auto formatting is done by assigning the renderer without any parameters to the column in question. This example makes use of the <a href=
				"https://momentjs.com/">Moment.js</a> library to handle date formats. <a href="https://moment.github.io/luxon/#/">Luxon</a> is also supported with an identical
				API.</p>
