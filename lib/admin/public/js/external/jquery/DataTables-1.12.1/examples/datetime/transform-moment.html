...
<head>
	...
	<title>DataTables example - Format transform (Moment.js)</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>Format transform (Moment.js)</span></h1>
			<div class="info">
				<p>There might be times where your wire date/time data is not in ISO8601 format, but you want to display it to the end user in yet another format. This is handled
				by the <code>datetime</code> rendering function by supplying it three parameters:</p>
				<ol class="markdown">
				...
				<p>The <code>datetime</code> formatter works with both <a href="https://momentjs.com/">Moment.js</a> and <a href="https://moment.github.io/luxon/#/">Luxon</a>. In
				this example we are using Moment.js. For a full range of its formatting options, please see the <a href="https://momentjs.com/docs/#/displaying/format/">Moment.js
				documentation</a>.</p>
