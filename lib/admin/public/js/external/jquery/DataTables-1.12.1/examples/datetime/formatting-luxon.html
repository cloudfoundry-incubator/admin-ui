...
<head>
	...
	<title>DataTables example - Date rendering (Luxon)</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>Date rendering (Luxon)</span></h1>
			<div class="info">
				<p>This example is identical to the <a href="formatting-moment.html">date rendering using Moment.js</a>, but in this case the example uses <a href=
				"https://moment.github.io/luxon/#/">Luxon</a> as the date time parsing library.</p>
				<p>The use of the <code>datetime</code> render for both Moment.js and Luxon is identical, although they each have their own formatting options. For the full range
				of Luxon formatting options please see the <a href="https://moment.github.io/luxon/#/formatting?id=table-of-tokens">Luxon documentation</a>.</p>
