...
<head>
	...
	<title>DataTables example - Ordering formatted dates (Moment.js)</title>
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables example <span>Ordering formatted dates (Moment.js)</span></h1>
			<div class="info">
				<p>You might wish to tell DataTables about a specific date/time format that your data contains, but either you don't wish to transform it into a different format,
				or you aren't sure which columns the date/time data will be in (i.e. can't use the <code>datetime</code> rendering function). For such cases, we provide a
				<code>DataTable.datetime()</code> function to which you provide a format string. This will instruct DataTables to look for and parse data in such a format.</p>
				<p>As with DataTable's other date and time methods, <code>DataTable.datetime()</code> supports both <a href="https://momentjs.com/">Moment.js</a> and <a href=
				"https://moment.github.io/luxon/#/">Luxon</a>. In this example we are using Moment.js. For a full range of its formatting options, please see the <a href=
				"https://momentjs.com/docs/#/displaying/format/">Moment.js documentation</a>. Note that the parsing is strict - your assigned format must exactly match the
				data.</p>
			</div>
			<div class="demo-html">
			...
			<div class="tabs">
				<div class="js">
					<p>The Javascript shown below is used to initialise the table shown in this example:</p><code class="multiline language-js">DataTable.datetime('D MMM YYYY');
...
$(document).ready(function () {
	$('#example').DataTable();
					...
					<ul>
						...
						<li>
							<a href=
							"https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.2/moment.min.js">https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.2/moment.min.js</a>
						</li>
						<li>
		...
		<div class="footer">
			...
			<div class="liner">
				...
				<div class="toc">
					...
					<div class="toc-group">
						<h3><a href="./index.html">DateTime</a></h3>
						<ul class="toc active">
							<li>
								<a href="./iso8601.html">ISO8601 detection</a>
							</li>
							<li>
								<a href="./auto-locale-moment.html">Auto-locale display (Luxon)</a>
							</li>
							<li>
								<a href="./auto-locale-luxon.html">Auto-locale display (Luxon)</a>
							</li>
							<li>
								<a href="./formatting-moment.html">Date rendering (Moment.js)</a>
							</li>
							<li>
								<a href="./formatting-luxon.html">Date rendering (Luxon)</a>
							</li>
							<li>
								<a href="./transform-moment.html">Format transform (Moment.js)</a>
							</li>
							<li>
								<a href="./transform-luxon.html">Format transform (Luxon)</a>
							</li>
							<li class="active">
								<a href="./order-moment.html">Ordering formatted dates (Moment.js)</a>
							</li>
							<li>
								<a href="./order-luxon.html">Ordering formatted dates (Luxon)</a>
							</li>
						</ul>
					</div>
					<div class="toc-group">
