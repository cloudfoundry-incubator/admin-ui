...
DomainsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addPropertyRow(table, "Shared", Format.formatBoolean(row[5]));
    ...
    this.addFilterRowIfValue(table, "Routes", Format.formatNumber, row[8], domain.name, AdminUI.showRoutes);
