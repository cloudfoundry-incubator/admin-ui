...
DomainsTab.prototype.initialize = function()
{
    ...
    this.domainsAnnotationsTable = Table.createTable("DomainsAnnotations", this.getDomainsAnnotationsColumns(), [[1, "asc"]], null, this.getDomainsAnnotationsActions(), Constants.FILENAME__DOMAIN_ANNOTATIONS, null, null);
    ...
    return [
               {
                   ...
                   render:    $.proxy(function(value, type, item)
                                      {
                                          return this.formatCheckbox("DomainsAnnotations", item[1], value);
                                      },
                                      this)
               },
               {
