...
DomainsTab.prototype.getActions = function()
{
    return [
               ...
               },
               {
                   ...
                   click: $.proxy(function()
                   {
                       this.deleteChecked("Are you sure you want to delete the selected domains and their associated routes, route mappings and route bindings?",
                                          "Delete Recursive",
...
DomainsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "Routes", Format.formatNumber, row[7], domain.name, AdminUI.showRoutes);
