...
UsersTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addRowIfValue(this.addPropertyRow, table, "Requests Count", Format.formatNumber, row[20]);
    ...
    this.addFilterRowIfValue(table, "Organization Total Roles", Format.formatNumber, row[22], user.id, AdminUI.showOrganizationRoles);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Auditor Roles", Format.formatNumber, row[23]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Billing Manager Roles", Format.formatNumber, row[24]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Manager Roles", Format.formatNumber, row[25]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization User Roles", Format.formatNumber, row[26]);
    this.addFilterRowIfValue(table, "Space Total Roles", Format.formatNumber, row[27], user.id, AdminUI.showSpaceRoles);
    this.addRowIfValue(this.addPropertyRow, table, "Space Auditor Roles", Format.formatNumber, row[28]);
    this.addRowIfValue(this.addPropertyRow, table, "Space Developer Roles", Format.formatNumber, row[29]);
    this.addRowIfValue(this.addPropertyRow, table, "Space Manager Roles", Format.formatNumber, row[30]);
