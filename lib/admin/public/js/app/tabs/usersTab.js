...
UsersTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "Events", Format.formatNumber, row[13], user.id, AdminUI.showEvents);
    this.addFilterRowIfValue(table, "Groups", Format.formatNumber, row[14], user.id, AdminUI.showGroupMembers);
    this.addFilterRowIfValue(table, "Approvals", Format.formatNumber, row[15], user.id, AdminUI.showApprovals);
    this.addRowIfValue(this.addPropertyRow, table, "Requests Count", Format.formatNumber, row[16]);
    ...
    this.addFilterRowIfValue(table, "Organization Total Roles", Format.formatNumber, row[18], user.id, AdminUI.showOrganizationRoles);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Auditor Roles", Format.formatNumber, row[19]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Billing Manager Roles", Format.formatNumber, row[20]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Manager Roles", Format.formatNumber, row[21]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization User Roles", Format.formatNumber, row[22]);
    this.addFilterRowIfValue(table, "Space Total Roles", Format.formatNumber, row[23], user.id, AdminUI.showSpaceRoles);
    this.addRowIfValue(this.addPropertyRow, table, "Space Auditor Roles", Format.formatNumber, row[24]);
    this.addRowIfValue(this.addPropertyRow, table, "Space Developer Roles", Format.formatNumber, row[25]);
    this.addRowIfValue(this.addPropertyRow, table, "Space Manager Roles", Format.formatNumber, row[26]);
