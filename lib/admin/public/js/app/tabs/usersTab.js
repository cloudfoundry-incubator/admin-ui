...
UsersTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (row[8] != null)
    {
        ...
        $(organizationRolesLink).html(Format.formatNumber(row[8]));
    ...
    this.addRowIfValue(this.addPropertyRow, table, "Organization Auditor Roles", Format.formatNumber, row[9]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Billing Manager Roles", Format.formatNumber, row[10]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Manager Roles", Format.formatNumber, row[11]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization User Roles", Format.formatNumber, row[12]);
    ...
    if (row[13] != null)
    {
        ...
        $(spaceRolesLink).html(Format.formatNumber(row[13]));
    ...
    this.addRowIfValue(this.addPropertyRow, table, "Space Auditor Roles", Format.formatNumber, row[14]);
    this.addRowIfValue(this.addPropertyRow, table, "Space Developer Roles", Format.formatNumber, row[15]);
    this.addRowIfValue(this.addPropertyRow, table, "Space Manager Roles", Format.formatNumber, row[16]);
