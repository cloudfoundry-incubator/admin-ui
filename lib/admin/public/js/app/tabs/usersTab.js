...
UsersTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "Organization Total Roles", Format.formatNumber, row[16], user.id, AdminUI.showOrganizationRoles);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Auditor Roles", Format.formatNumber, row[17]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Billing Manager Roles", Format.formatNumber, row[18]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization Manager Roles", Format.formatNumber, row[19]);
    this.addRowIfValue(this.addPropertyRow, table, "Organization User Roles", Format.formatNumber, row[20]);
    this.addFilterRowIfValue(table, "Space Total Roles", Format.formatNumber, row[21], user.id, AdminUI.showSpaceRoles);
    this.addRowIfValue(this.addPropertyRow, table, "Space Auditor Roles", Format.formatNumber, row[22]);
    this.addRowIfValue(this.addPropertyRow, table, "Space Developer Roles", Format.formatNumber, row[23]);
    this.addRowIfValue(this.addPropertyRow, table, "Space Manager Roles", Format.formatNumber, row[24]);
