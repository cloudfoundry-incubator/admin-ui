...
ComponentsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (varzComponent != null)
    {
        ...
        this.addPropertyRow(table, "Index", Format.formatNumber(varzComponent.index));
        ...
        this.addStateRow(table, "State", row[4]);
    }
    else if (dopplerComponent != null)
    {
        ...
        this.addPropertyRow(table, "Index", Format.formatNumber(dopplerComponent.index));
        this.addPropertyRow(table, "Source", Format.formatString(row[3]));
        this.addPropertyRow(table, "Metrics Last Gathered", Format.formatDateString(row[6]));
        this.addStateRow(table, "State", row[4]);
    }
};
