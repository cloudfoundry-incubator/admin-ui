...
CellsTab.prototype.showDetails = function(table, cell, row)
{
    ...
    this.addPropertyRow(table, "Metrics Last Gathered", Format.formatDateString(row[4]));
    ...
    if (row[12] != null)
    {
        this.addFilterRow(table, "Used Containers", Format.formatNumber(row[12]), Format.formatString(row[0]), AdminUI.showApplicationInstances);
    }
