...
TasksTab.prototype.initialize = function()
{
    ...
    this.tasksAnnotationsTable = Table.createTable("TasksAnnotations", this.getTasksAnnotationsColumns(), [[1, "asc"]], null, this.getTasksAnnotationsActions(), Constants.FILENAME__TASK_ANNOTATIONS, null, null);
};
    ...
    return [
               {
                   ...
                   render:    $.proxy(function(value, type, item)
                                      {
                                          return this.formatCheckbox("TasksAnnotations", item[1], value);
                                      },
                                      this)
               },
               {
