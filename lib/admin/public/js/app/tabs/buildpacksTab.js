...
BuildpacksTab.prototype.initialize = function()
{
    ...
    this.buildpacksAnnotationsTable = Table.createTable("BuildpacksAnnotations", this.getBuildpacksAnnotationsColumns(), [[1, "asc"]], null, this.getBuildpacksAnnotationsActions(), Constants.FILENAME__BUILDPACK_ANNOTATIONS, null, null);
};
    ...
    return [
               {
                   ...
                   render:    $.proxy(function(value, type, item)
                                      {
                                          return this.formatCheckbox("BuildpacksAnnotations", item[1], value);
                                      },
                                      this)
               },
               {
