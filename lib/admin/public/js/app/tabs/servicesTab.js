...
ServicesTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (row[11] != null)
    {
        this.addFilterRow(table, "Service Instances", Format.formatNumber(row[11]), service.guid, AdminUI.showServiceInstances);
    }
    
    if (row[12] != null)
    {
        this.addFilterRow(table, "Service Bindings", Format.formatNumber(row[12]), service.guid, AdminUI.showServiceBindings);
    }
