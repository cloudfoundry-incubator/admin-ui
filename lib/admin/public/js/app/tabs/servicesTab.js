...
ServicesTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (row[13] != null)
    {
        this.addFilterRow(table, "Service Events", Format.formatNumber(row[13]), service.guid, AdminUI.showEvents);
    }
    
    if (row[14] != null)
    {
        this.addFilterRow(table, "Service Plans", Format.formatNumber(row[14]), service.guid, AdminUI.showServicePlans);
    }
    ...
    if (row[16] != null)
    {
        this.addFilterRow(table, "Service Plan Visibilities", Format.formatNumber(row[16]), service.guid, AdminUI.showServicePlanVisibilities);
    }
    
    if (row[17] != null)
    {
        this.addFilterRow(table, "Service Instances", Format.formatNumber(row[17]), service.guid, AdminUI.showServiceInstances);
    }
    
    if (row[18] != null)
    {
        this.addFilterRow(table, "Service Bindings", Format.formatNumber(row[18]), service.guid, AdminUI.showServiceBindings);
    }
    
    if (row[19] != null)
    {
        this.addFilterRow(table, "Service Keys", Format.formatNumber(row[19]), service.guid, AdminUI.showServiceKeys);
    }
