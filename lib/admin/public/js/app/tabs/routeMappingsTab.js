...
RouteMappingsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    // The app_route.guid can be null if this is old-style app_route
    this.addJSONDetailsLinkRow(table, "GUID", Format.formatString(app_route.guid), objects, true);

    this.addRowIfValue(this.addPropertyRow, table, "Created", Format.formatDateString, app_route.created_at);
