    ...
    return [
               {
                   ...
                   {
                       return this.formatCheckbox(value, value);
                   },
                   this),
               },
               {
...
RouteMappingsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    var route_mapping = objects.route_mapping;
    var space         = objects.space;

    this.addJSONDetailsLinkRow(table, "GUID", Format.formatString(route_mapping.guid), objects, true);

    this.addPropertyRow(table, "Created", Format.formatDateString(route_mapping.created_at));
    this.addRowIfValue(this.addPropertyRow, table, "Updated", Format.formatDateString, route_mapping.updated_at);
    ...
    this.addRowIfValue(this.addPropertyRow, table, "Application Port", Format.formatNumber, route_mapping.application_port);
