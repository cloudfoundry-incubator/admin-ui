...
function LogsTab(id)
{
    Tab.call(this, id, Constants.URL__LOGS_VIEW_MODEL);
}
...
LogsTab.prototype.retrieveLog = function(logPath, start, forward, refreshing)
{
    ...
    {
        AdminUI.showDialog("Error", "There was an error paging the log: <br/><br/>" + error);
    });
};
...
LogsTab.prototype.handleLogScrolled = function()
{
    ...
    //this.currentLog.scrollLeft = $("#LogContents").scrollLeft();
};
