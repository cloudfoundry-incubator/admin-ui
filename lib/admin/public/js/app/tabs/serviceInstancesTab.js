...
ServiceInstancesTab.prototype.initialize = function()
{
    ...
    this.serviceInstancesAnnotationsTable = Table.createTable("ServiceInstancesAnnotations", this.getServiceInstancesAnnotationsColumns(), [[1, "asc"]], null, this.getServiceInstancesAnnotationsActions(), Constants.FILENAME__SERVICE_INSTANCE_ANNOTATIONS, null, null);
    ...
    return [
               {
                   ...
                   render:    $.proxy(function(value, type, item)
                                      {
                                          return this.formatCheckbox("ServiceInstancesAnnotations", item[1], value);
                                      },
                                      this)
               },
               {
