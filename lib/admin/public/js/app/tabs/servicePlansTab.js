...
{
    this.url = Constants.URL__SERVICE_PLANS_TAB;
...
ServicePlansTab.prototype.showDetails = function(table, target, row)
{
...
ServicePlansTab.prototype.changeVisibility = function(targetedVisibility) 
{
    ...
    for (var rowIdx = 0, rowCount = rows.length; rowIdx < rowCount; rowIdx++) 
    {
        ...
        var url = "/service_plans/" + row.guid;
...
ServicePlansTab.prototype.showServicePlans = function(filter) 
{
