...
ServicePlansTab.prototype.clickHandler = function(event) 
{
    ...
    this.hideDetails();
    var hitchWhenHavingValue = function(scope, rowFunc, lable, formatter)
    {
    ...
    if (selected.length > 0)
    {
        ...
        if (servicePlan != null)
        {
            ...
            hitchWhenHavingValue(this, this.addPropertyRow,           "Service Plan Updated",          Format.formatDateString, servicePlan.updated_at);
        ...
        if (serviceBroker != null)
        {
            ...
            hitchWhenHavingValue(this, this.addPropertyRow,           "Service Broker Updated",        Format.formatDateString, serviceBroker.updated_at);
        }
        ...
        if (service != null)
        {
            ...
            hitchWhenHavingValue(    this, this.addPropertyRow,        "Service Created",              Format.formatDateString, service.created_at);
            hitchWhenHavingValue(    this, this.addPropertyRow,        "Service Updated",              Format.formatDateString, service.updated_at);
