...
ServicePlansTab.prototype.changeVisibility = function(targetedVisibility) 
{
    ...
    try
    {
        for (var step = 0; step < servicePlans.length; step++) 
        {
            var servicePlan = servicePlans[step];
            var url = Constants.URL__SERVICE_PLANS + "/" + servicePlan;
...
ServicePlansTab.prototype.getSelectedServicePlans = function() 
{
    ...
    {
        servicePlans.push(checkedRows[step].value);
    }
