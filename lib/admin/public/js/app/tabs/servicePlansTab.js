...
ServicePlansTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (servicePlan.create_instance_schema != null) 
    {
        try
        {
            var json = jQuery.parseJSON(servicePlan.create_instance_schema);
            this.addJSONDetailsLinkRow(table, "Service Plan Create Instance Schema", Format.formatStringCleansed(servicePlan.create_instance_schema), json, false);
        }
        catch (error)
        {
            this.addPropertyRow(table, "Service Plan Create Instance Schema", Format.formatStringCleansed(servicePlan.create_instance_schema));
        }
    }

    if (servicePlan.update_instance_schema != null) 
    {
        try
        {
            var json = jQuery.parseJSON(servicePlan.update_instance_schema);
            this.addJSONDetailsLinkRow(table, "Service Plan Update Instance Schema", Format.formatStringCleansed(servicePlan.update_instance_schema), json, false);
        }
        catch (error)
        {
            this.addPropertyRow(table, "Service Plan Update Instance Schema", Format.formatStringCleansed(servicePlan.update_instance_schema));
        }
    }
