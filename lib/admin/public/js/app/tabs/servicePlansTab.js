...
ServicePlansTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (servicePlan != null)
    {
        ...
        this.addFilterRowIfValue(table, "Service Plan Events", Format.formatNumber, row[10], servicePlan.guid, AdminUI.showEvents);
        this.addFilterRowIfValue(table, "Service Plan Visibilities", Format.formatNumber, row[11], servicePlan.guid, AdminUI.showServicePlanVisibilities);
        this.addFilterRowIfValue(table, "Service Instances", Format.formatNumber, row[12], servicePlan.guid, AdminUI.showServiceInstances);
        this.addFilterRowIfValue(table, "Service Bindings", Format.formatNumber, row[13], servicePlan.guid, AdminUI.showServiceBindings);
        this.addFilterRowIfValue(table, "Service Keys", Format.formatNumber, row[14], servicePlan.guid, AdminUI.showServiceKeys);
    }
