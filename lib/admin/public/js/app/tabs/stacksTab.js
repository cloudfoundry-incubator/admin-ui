...
StacksTab.prototype.initialize = function()
{
    ...
    this.stacksAnnotationsTable = Table.createTable("StacksAnnotations", this.getStacksAnnotationsColumns(), [[1, "asc"]], null, this.getStacksAnnotationsActions(), Constants.FILENAME__STACK_ANNOTATIONS, null, null);
};
    ...
    return [
               {
                   ...
                   render:    $.proxy(function(value, type, item)
                                      {
                                          return this.formatCheckbox("StacksAnnotations", item[1], value);
                                      },
                                      this)
               },
               {
