...
StacksTab.prototype.showDetails = function(table, stack, row)
{
    ...
    this.addFilterRowIfValue(table, "Applications", Format.formatNumber,  row[4], stack.name, AdminUI.showApplications);
    this.addFilterRowIfValue(table, "Application Instances", Format.formatNumber, row[5], stack.name, AdminUI.showApplicationInstances);
};
