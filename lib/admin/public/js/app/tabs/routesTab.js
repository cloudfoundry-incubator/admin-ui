...
RoutesTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addJSONDetailsLinkRow(table, "Host", Format.formatString(route.host), objects, true);
    ...
    if (domain != null)
    {
        ...
        this.addFilterRow(table, "Applications", Format.formatNumber(row[7].length), fqdn, AdminUI.showApplications);
    }
