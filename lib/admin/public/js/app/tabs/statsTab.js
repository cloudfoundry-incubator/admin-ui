...
{
    this.url = Constants.URL__STATS_VIEW_MODEL;
...
{
    this.table = Table.createTable(this.id, this.getColumns(), this.getInitialSort(), null, this.getActions(), this.url);
};
...
StatsTab.prototype.refreshServerSide = function(reload)
{
    Tab.prototype.refreshServerSide.call(this, reload);
