...
SpacesTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (row[5] != null)
    {
        ...
        $(rolesLink).html(Format.formatNumber(row[5]));
        $(rolesLink).click(function()
        {
            AdminUI.showSpaceRoles(Format.formatString(row[2]));
    ...
    if (row[6] != null)
    {
        ...
        $(routesLink).html(Format.formatNumber(row[6]));
        $(routesLink).click(function()
        {
            AdminUI.showRoutes(Format.formatString(row[2]));
    ...
    if (row[9] != null)
    {
        ...
        $(instancesLink).html(Format.formatNumber(row[9]));
    ...
    if (row[10] != null)
    {
        ...
        $(servicesLink).html(Format.formatNumber(row[10]));
        $(servicesLink).click(function()
        {
            AdminUI.showServiceInstances(Format.formatString(row[2]));
    ...
    if (row[16] != null)
    {
        ...
        $(appsLink).html(Format.formatNumber(row[16]));
