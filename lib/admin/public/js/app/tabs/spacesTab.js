...
SpacesTab.prototype.showDetails = function(table, target, row)
{
    ...
    this.addPropertyRow(table, "Unused Routes", Format.formatNumber(row[6]));

    var instancesLink = document.createElement("a");
    $(instancesLink).attr("href", "");
    $(instancesLink).addClass("tableLink");
    $(instancesLink).html(Format.formatNumber(row[7]));
    ...
    $(appsLink).html(Format.formatNumber(row[14]));
    ...
    this.addPropertyRow(table, "Started Apps",    Format.formatNumber(row[15]));
    this.addPropertyRow(table, "Stopped Apps",    Format.formatNumber(row[16]));
    this.addPropertyRow(table, "Pending Apps",    Format.formatNumber(row[17]));
    this.addPropertyRow(table, "Staged Apps",     Format.formatNumber(row[18]));
    this.addPropertyRow(table, "Failed Apps",     Format.formatNumber(row[19]));
}
