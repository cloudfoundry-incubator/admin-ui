...
SpacesTab.prototype.initialize = function()
{
    ...
    this.spacesAnnotationsTable = Table.createTable("SpacesAnnotations", this.getSpacesAnnotationsColumns(), [[1, "asc"]], null, this.getSpacesAnnotationsActions(), Constants.FILENAME__SPACE_ANNOTATIONS, null, null);
};
    ...
    return [
               {
                   ...
                   render:    $.proxy(function(value, type, item)
                                      {
                                          return this.formatCheckbox("SpacesAnnotations", item[1], value);
                                      },
                                      this)
               },
               {
