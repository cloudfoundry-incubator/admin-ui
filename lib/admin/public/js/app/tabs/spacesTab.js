...
SpacesTab.prototype.getActions = function()
{
    return [
               ...
               },
               {
                   ...
                   {
                       this.deleteChecked(this.id,
                                          "Are you sure you want to delete the selected spaces and their contained applications, routes, route mappings, private service brokers, service instances, service bindings, service keys and route bindings?",
                                          "Delete Recursive",
