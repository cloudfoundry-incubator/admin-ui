...
SpacesTab.prototype.getTableData = function(results)
{
    ...
    for (var spaceIndex in spaces)
    {
        ...
        var routesString = (spaceRouteCounters['totalRoutes'] - spaceRouteCounters['unusedRoutes']) || 0;
        routesString += "/";
        routesString += spaceRouteCounters['totalRoutes'] || 0;
        ...
        if (spaceCounters)
        {
            ...
            row.push(spaceRouteCounters['totalRoutes']  || 0);
            row.push(spaceRouteCounters['unusedRoutes'] || 0);
        }
        else
        {
...
SpacesTab.prototype.showDetails = function(table, target, row)
{
    ...
    var routeString = row[18];
    if (row[19] > 0)
    {
        routeString += ", " + row[19] + " of them have no applications bound.";
    }
