...
SpacesTab.prototype.showDetails = function(table, target, row)
{
    ...
    $(appsLink).html(Format.formatNumber(row[4]));
    ...
    this.addPropertyRow(table, "Started Apps",    Format.formatNumber(row[5]));
    this.addPropertyRow(table, "Stopped Apps",    Format.formatNumber(row[6]));
    this.addPropertyRow(table, "Pending Apps",    Format.formatNumber(row[7]));
    this.addPropertyRow(table, "Staged Apps",     Format.formatNumber(row[8]));
    this.addPropertyRow(table, "Failed Apps",     Format.formatNumber(row[9]));
