...
SpacesTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (row[7] != null)
    {
        this.addFilterRow(table, "Events", Format.formatNumber(row[7]), space.guid, AdminUI.showEvents);
    }
    
    if (row[8] != null)
    {
        this.addFilterRow(table, "Events Target", Format.formatNumber(row[8]), Format.formatString(row[3]), AdminUI.showEvents);
    }
    
    if (row[9] != null)
    {
        this.addFilterRow(table, "Roles", Format.formatNumber(row[9]), space.guid, AdminUI.showSpaceRoles);
    }
    
    if (row[10] != null)
    {
        this.addFilterRow(table, "Default Users", Format.formatNumber(row[10]), Format.formatString(row[3]), AdminUI.showUsers);
    }
    ...
    if (row[12] != null)
    {
        this.addFilterRow(table, "Private Service Brokers", Format.formatNumber(row[12]), Format.formatString(row[3]), AdminUI.showServiceBrokers);
    }
    
    if (row[13] != null)
    {
        this.addFilterRow(table, "Security Groups", Format.formatNumber(row[13]), space.guid, AdminUI.showSecurityGroupsSpaces);
    }
    
    if (row[14] != null)
    {
        this.addFilterRow(table, "Total Routes", Format.formatNumber(row[14]), Format.formatString(row[3]), AdminUI.showRoutes);
    }
    ...
    if (row[17] != null)
    {
        this.addFilterRow(table, "Instances Used", Format.formatNumber(row[17]), Format.formatString(row[3]), AdminUI.showApplicationInstances);
    }

    if (row[18] != null)
    {
        this.addFilterRow(table, "Services Used", Format.formatNumber(row[18]), Format.formatString(row[3]), AdminUI.showServiceInstances);
    }
    ...
    if (row[24] != null)
    {
        this.addFilterRow(table, "Total Apps", Format.formatNumber(row[24]), Format.formatString(row[3]), AdminUI.showApplications);
    }
