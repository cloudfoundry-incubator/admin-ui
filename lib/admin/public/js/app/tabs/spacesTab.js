...
SpacesTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (row[11] != null)
    {
        this.addFilterRow(table, "Total Routes", Format.formatNumber(row[11]), Format.formatString(row[3]), AdminUI.showRoutes);
    }
    ...
    if (row[14] != null)
    {
        this.addFilterRow(table, "Instances Used", Format.formatNumber(row[14]), Format.formatString(row[3]), AdminUI.showApplicationInstances);
    }

    if (row[15] != null)
    {
        this.addFilterRow(table, "Services Used", Format.formatNumber(row[15]), Format.formatString(row[3]), AdminUI.showServiceInstances);
    }
    ...
    if (row[21] != null)
    {
        this.addFilterRow(table, "Total Apps", Format.formatNumber(row[21]), Format.formatString(row[3]), AdminUI.showApplications);
    }
