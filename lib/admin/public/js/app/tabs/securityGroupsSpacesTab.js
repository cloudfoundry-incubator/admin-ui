...
{
    Tab.call(this, id, Constants.URL__SECURITY_GROUPS_SPACES_VIEW_MODEL);
}
...
SecurityGroupsSpacesTab.prototype.getInitialSort = function()
{
    return [[1, "asc"], [5, "asc"]];
};
    ...
    return [
               {
                   ...
                   {
                       this.deleteChecked("Are you sure you want to delete the selected security groups spaces?",
                                          "Delete",
