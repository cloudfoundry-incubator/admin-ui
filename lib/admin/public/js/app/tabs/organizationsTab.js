...
OrganizationsTab.prototype.getTableData = function(results)
{
    ...
    for (var organizationIndex in organizations)
    {
        ...
        if (organizationRouteCounters)
        {
            var routesString = (organizationRouteCounters['totalRoutes'] - organizationRouteCounters['unusedRoutes']);
            routesString += "/";
            routesString += organizationRouteCounters['totalRoutes'];
        ...
        {
            Utilities.addZeroElementsToArray(row, 2);
        }
