...
OrganizationsTab.prototype.showDetails = function(table, organization, row)
{
    ...
    $(domainsLink).html(Format.formatNumber(row[8]));
    ...
    $(routesLink).html(Format.formatNumber(row[9]));
    ...
    this.addPropertyRow(table, "Used Routes", Format.formatNumber(row[10]));
    this.addPropertyRow(table, "Unused Routes", Format.formatNumber(row[11]));

    var instancesLink = document.createElement("a");
    $(instancesLink).attr("href", "");
    $(instancesLink).addClass("tableLink");
    $(instancesLink).html(Format.formatNumber(row[12]));
    ...
    $(servicesLink).html(Format.formatNumber(row[13]));
    ...
    this.addPropertyRow(table, "Memory Used",     Format.formatNumber(row[14]));
    this.addPropertyRow(table, "Disk Used",       Format.formatNumber(row[15]));
    this.addPropertyRow(table, "CPU Used",        Format.formatNumber(row[16]));
    ...
    $(appsLink).html(Format.formatNumber(row[19]));
    ...
    this.addPropertyRow(table, "Started Apps",    Format.formatNumber(row[20]));
    this.addPropertyRow(table, "Stopped Apps",    Format.formatNumber(row[21]));
    this.addPropertyRow(table, "Pending Apps",    Format.formatNumber(row[22]));
    this.addPropertyRow(table, "Staged Apps",     Format.formatNumber(row[23]));
    this.addPropertyRow(table, "Failed Apps",     Format.formatNumber(row[24]));
};
