...
OrganizationsTab.prototype.initialize = function()
{
    ...
    this.organizationsAnnotationsTable = Table.createTable("OrganizationsAnnotations", this.getOrganizationsAnnotationsColumns(), [[1, "asc"]], null, this.getOrganizationsAnnotationsActions(), Constants.FILENAME__ORGANIZATION_ANNOTATIONS, null, null);
};
    ...
    return [
               {
                   ...
                   render:    $.proxy(function(value, type, item)
                                      {
                                          return this.formatCheckbox("OrganizationsAnnotations", item[1], value);
                                      },
                                      this)
               },
               {
