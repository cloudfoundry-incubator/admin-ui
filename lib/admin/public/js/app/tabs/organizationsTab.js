...
OrganizationsTab.prototype.manageOrganizations = function(type)
{
    ...
    AdminUI.showModalDialogConfirmation(confirmation,
                                        ...
                                        $.proxy(function()
                                        {
                                            this.updateOrganizations(controlMessage);
                                        }, this));
}
                                        ...
                                        function()
                                        {
                                            ...
                                            finally
                                            {
                                                if (errorOrgs.length > 0)
                                                {
                                                    ...
                                                    for (var index = 0; index < errorOrgs.length; index++)
                                                    {
                                                        errorOrg = errorOrgs[index];
...
OrganizationsTab.prototype.updateOrganizations = function(controlMessage)
{
