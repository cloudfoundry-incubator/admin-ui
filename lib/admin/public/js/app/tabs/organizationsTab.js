...
OrganizationsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "Total Apps", Format.formatNumber, row[20], target, AdminUI.showApplications);
    this.addFilterRowIfValue(table, "Instances Used", Format.formatNumber, row[21], target, AdminUI.showApplicationInstances);
    this.addFilterRowIfValue(table, "Services Used", Format.formatNumber, row[22], target, AdminUI.showServiceInstances);
    this.addFilterRowIfValue(table, "Tasks Used", Format.formatNumber, row[23], target, AdminUI.showTasks);
    this.addRowIfValue(this.addPropertyRow, table, "Memory Used", Format.formatNumber, row[24]);
    this.addRowIfValue(this.addPropertyRow, table, "Disk Used", Format.formatNumber, row[25]);
    this.addRowIfValue(this.addPropertyRow, table, "CPU Used",  Format.formatNumber, row[26]);
    this.addRowIfValue(this.addPropertyRow, table, "Memory Reserved", Format.formatNumber, row[27]);
    this.addRowIfValue(this.addPropertyRow, table, "Disk Reserved",   Format.formatNumber, row[28]);
    this.addRowIfValue(this.addPropertyRow, table, "Desired Started Apps", Format.formatNumber, row[29]);
    this.addRowIfValue(this.addPropertyRow, table, "Desired Stopped Apps", Format.formatNumber, row[30]);
    this.addRowIfValue(this.addPropertyRow, table, "Started Apps", Format.formatNumber, row[31]);
    this.addRowIfValue(this.addPropertyRow, table, "Stopped Apps", Format.formatNumber, row[32]);
    this.addRowIfValue(this.addPropertyRow, table, "Pending Apps",  Format.formatNumber, row[33]);
    this.addRowIfValue(this.addPropertyRow, table, "Staged Apps",  Format.formatNumber, row[34]);
    this.addRowIfValue(this.addPropertyRow, table, "Failed Apps",  Format.formatNumber, row[35]);
    ...
    this.addFilterRowIfValue(table, "Related Isolation Segments", Format.formatNumber, row[38], organization.guid, AdminUI.showOrganizationsIsolationSegments);
};
