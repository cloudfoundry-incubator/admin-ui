...
OrganizationsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (row[10] != null)
    {
        this.addFilterRow(table, "Default Users", Format.formatNumber(row[10]), target, AdminUI.showUsers);
    }
    ...
    if (row[12] != null)
    {
        this.addFilterRow(table, "Space Quotas", Format.formatNumber(row[12]), organization.guid, AdminUI.showSpaceQuotas);
    }
    
    if (row[13] != null)
    {
        this.addFilterRow(table, "Domains", Format.formatNumber(row[13]), organization.name, AdminUI.showDomains);
    }
    
    if (row[14] != null)
    {
        this.addFilterRow(table, "Private Service Brokers", Format.formatNumber(row[14]), target, AdminUI.showServiceBrokers);
    }
    
    if (row[15] != null)
    {
        this.addFilterRow(table, "Service Plan Visibilities", Format.formatNumber(row[15]), organization.guid, AdminUI.showServicePlanVisibilities);
    }
    
    if (row[16] != null)
    {
        this.addFilterRow(table, "Security Groups", Format.formatNumber(row[16]), target, AdminUI.showSecurityGroupsSpaces);
    }

    if (row[17] != null)
    {
        this.addFilterRow(table, "Total Routes", Format.formatNumber(row[17]), target, AdminUI.showRoutes);
    }
    ...
    if (row[20] != null)
    {
        this.addFilterRow(table, "Instances Used", Format.formatNumber(row[20]), target, AdminUI.showApplicationInstances);
    }

    if (row[21] != null)
    {
        this.addFilterRow(table, "Services Used", Format.formatNumber(row[21]), target, AdminUI.showServiceInstances);
    }
    ...
    if (row[27] != null)
    {
        this.addFilterRow(table, "Total Apps", Format.formatNumber(row[27]), target, AdminUI.showApplications);
    }
