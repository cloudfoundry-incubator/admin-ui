...
OrganizationsTab.prototype.getActions = function()
{
    return [
               ...
               },
               {
                   ...
                   click: $.proxy(function()
                   {
                       this.deleteChecked("Are you sure you want to delete the selected organizations and their contained spaces, space quotas, applications, routes, route mappings, private service brokers, service instances, service bindings, service keys and route bindings?",
                                          "Delete Recursive",
...
OrganizationsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "Staging Security Groups", Format.formatNumber, row[17], target, AdminUI.showStagingSecurityGroupsSpaces);
    this.addFilterRowIfValue(table, "Total Routes", Format.formatNumber, row[18], target, AdminUI.showRoutes);
    this.addRowIfValue(this.addPropertyRow, table, "Used Routes", Format.formatNumber, row[19]);
    this.addRowIfValue(this.addPropertyRow, table, "Unused Routes", Format.formatNumber, row[20]);
    this.addFilterRowIfValue(table, "Total Apps", Format.formatNumber, row[21], target, AdminUI.showApplications);
    this.addFilterRowIfValue(table, "Instances Used", Format.formatNumber, row[22], target, AdminUI.showApplicationInstances);
    this.addFilterRowIfValue(table, "Services Used", Format.formatNumber, row[23], target, AdminUI.showServiceInstances);
    this.addFilterRowIfValue(table, "Tasks Used", Format.formatNumber, row[24], target, AdminUI.showTasks);
    this.addRowIfValue(this.addPropertyRow, table, "Memory Used", Format.formatNumber, row[25]);
    this.addRowIfValue(this.addPropertyRow, table, "Disk Used", Format.formatNumber, row[26]);
    this.addRowIfValue(this.addPropertyRow, table, "CPU Used",  Format.formatNumber, row[27]);
    this.addRowIfValue(this.addPropertyRow, table, "Memory Reserved", Format.formatNumber, row[28]);
    this.addRowIfValue(this.addPropertyRow, table, "Disk Reserved",   Format.formatNumber, row[29]);
    this.addRowIfValue(this.addPropertyRow, table, "Desired Started Apps", Format.formatNumber, row[30]);
    this.addRowIfValue(this.addPropertyRow, table, "Desired Stopped Apps", Format.formatNumber, row[31]);
    this.addRowIfValue(this.addPropertyRow, table, "Started Apps", Format.formatNumber, row[32]);
    this.addRowIfValue(this.addPropertyRow, table, "Stopped Apps", Format.formatNumber, row[33]);
    this.addRowIfValue(this.addPropertyRow, table, "Pending Apps",  Format.formatNumber, row[34]);
    this.addRowIfValue(this.addPropertyRow, table, "Staged Apps",  Format.formatNumber, row[35]);
    this.addRowIfValue(this.addPropertyRow, table, "Failed Apps",  Format.formatNumber, row[36]);
    ...
    this.addFilterRowIfValue(table, "Related Isolation Segments", Format.formatNumber, row[39], organization.guid, AdminUI.showOrganizationsIsolationSegments);
};
