...
OrganizationsTab.prototype.getActions = function()
{
    return [
               ...
               },
               {
                   ...
                   {
                       this.deleteChecked(this.id,
                                          "Are you sure you want to delete the selected organizations and their contained spaces, space quotas, applications, routes, route mappings, private service brokers, service instances, service bindings, service keys and route bindings?",
                                          "Delete Recursive",
