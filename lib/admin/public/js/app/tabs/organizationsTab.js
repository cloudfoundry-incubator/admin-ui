...
OrganizationsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    var quota_definition = objects.quota_definition;
    ...
    if (quota_definition != null)
    {
        this.addFilterRow(table, "Quota", Format.formatStringCleansed(quota_definition.name), quota_definition.name, AdminUI.showQuotas);
    }

    if (row[11] != null)
    {
        this.addFilterRow(table, "Domains", Format.formatNumber(row[11]), organization.name, AdminUI.showDomains);
    }
    
    if (row[12] != null)
    {
        this.addFilterRow(table, "Service Plan Visibilities", Format.formatNumber(row[12]), organization.guid, AdminUI.showServicePlanVisibilities);
    }
    
    if (row[13] != null)
    {
        this.addFilterRow(table, "Total Routes", Format.formatNumber(row[13]), target, AdminUI.showRoutes);
    }
    ...
    if (row[16] != null)
    {
        this.addFilterRow(table, "Instances Used", Format.formatNumber(row[16]), target, AdminUI.showApplications);
    }

    if (row[17] != null)
    {
        this.addFilterRow(table, "Services Used", Format.formatNumber(row[17]), target, AdminUI.showServiceInstances);
    }
    ...
    if (row[23] != null)
    {
        this.addFilterRow(table, "Total Apps", Format.formatNumber(row[23]), target, AdminUI.showApplications);
    }
