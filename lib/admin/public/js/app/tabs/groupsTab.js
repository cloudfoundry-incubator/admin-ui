    ...
    return [
               {
                   ...
                   {
                       this.deleteChecked("Are you sure you want to delete the selected groups?",
                                          "Delete",
                                          "Deleting Groups",
...
GroupsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (row[7] != null)
    {
        this.addFilterRow(table, "Members", Format.formatNumber(row[7]), group.displayname, AdminUI.showGroupMembers);
    }
};
