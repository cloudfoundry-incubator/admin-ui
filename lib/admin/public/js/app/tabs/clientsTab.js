...
ClientsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "Events", Format.formatNumber, row[11], client.client_id, AdminUI.showEvents);
    this.addFilterRowIfValue(table, "Approvals", Format.formatNumber, row[12], client.client_id, AdminUI.showApprovals);
