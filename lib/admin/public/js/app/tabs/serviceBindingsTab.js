    ...
    return [
               {
                   ...
                   {
                       this.deleteChecked("Are you sure you want to delete the selected service bindings?",
                                          "Delete",
...
ServiceBindingsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    if (row[4] != null)
    {
        this.addFilterRow(table, "Service Binding Events", Format.formatNumber(row[4]), serviceBinding.guid, AdminUI.showEvents);
    }
