...
ApplicationInstancesTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addFilterRowIfValue(table, "DEA", Format.formatStringCleansed, row[16], row[16], AdminUI.showDEAs);
    this.addFilterRowIfValue(table, "Cell", Format.formatStringCleansed, row[17], row[17], AdminUI.showCells);
};
