...
IdentityZonesTab.prototype.showDetails = function(table, identityZone, row)
{
    ...
    this.addFilterRowIfValue(table, "Clients", Format.formatNumber, row[7], identityZone.id, AdminUI.showClients);
    this.addFilterRowIfValue(table, "Users", Format.formatNumber, row[8], identityZone.id, AdminUI.showUsers);
};
