...
ApplicationsTab.prototype.clickHandler = function()
{
    ...
    if (selected.length > 0)
    {
        ...
        Utilities.hitchWhenHavingValue(this, table, this.addPropertyRow,        "Created",             Format.formatDate,   row[5] );
        Utilities.hitchWhenHavingValue(this, table, this.addPropertyRow,        "Updated",             Format.formatDate,   row[6] );

        if (row[7] != "")
        {
            this.addPropertyRow(table, "Started", Format.formatDateNumber(row[7]));
        }
