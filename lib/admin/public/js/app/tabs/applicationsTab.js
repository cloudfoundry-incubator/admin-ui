...
ApplicationsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    var current_droplet = objects.current_droplet;
    var current_package = objects.current_package;
    var latest_droplet  = objects.latest_droplet;
    var latest_package  = objects.latest_package;
    var organization    = objects.organization;
    var process         = objects.process;
    var space           = objects.space;
    var stack           = objects.stack;

    var droplet = current_droplet;

    if (droplet == null)
    {
        droplet = latest_droplet;
    }
    var packag = current_package;

    if (packag == null)
    {
        packag = latest_package;
    }
    ...
    this.addRowIfValue(this.addPropertyRow, table, "SSH Enabled", Format.formatBoolean, row[9]);
    ...
    this.addFilterRowIfValue(table, "Stack", Format.formatStringCleansed, row[11], row[11], AdminUI.showStacks);
    ...
    this.addRowIfValue(this.addPropertyRow, table, "Buildpack", Format.formatString, row[12]);
