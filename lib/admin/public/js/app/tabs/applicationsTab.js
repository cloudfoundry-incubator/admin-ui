...
{
    this.url = Constants.URL__APPLICATIONS_VIEW_MODEL;
...
ApplicationsTab.prototype.initialize = function()
{
    ...
    this.applicationServicesTable = Table.createTable("ApplicationsServices", this.getApplicationServicesColumns(), [[0, "asc"]], null, null, false);
};
...
ApplicationsTab.prototype.clickHandler = function()
{
    ...
    if (selected.length > 0)
    {
        ...
        this.addRowIfValue(this.addPropertyRow, table, "State", Format.formatString, row[2]);
        this.addRowIfValue(this.addPropertyRow, table, "Package State", Format.formatString, row[3]);
        ...
        this.addRowIfValue(this.addPropertyRow, table, "Created", Format.formatDateString, row[5]);
        this.addRowIfValue(this.addPropertyRow, table, "Updated", Format.formatDateString, row[6]);
        this.addRowIfValue(this.addPropertyRow, table, "Started", Format.formatDateNumber, row[7]);
        ...
        this.addRowIfValue(this.addPropertyRow, table, "Instance Index", Format.formatNumber, row[10]);
        ...
        this.addRowIfValue(this.addPropertyRow, table, "Services Used", Format.formatNumber, row[11]);
