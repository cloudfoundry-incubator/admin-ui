...
ApplicationsTab.prototype.clickHandler = function()
{
    ...
    if (selected.length > 0)
    {
        ...
        if (row[7] !== "")
        {
            this.addPropertyRow(table, "Services", Format.formatNumber(row[7]));
        }
        ...
        this.addPropertyRow(table, "Memory Reserved",  Format.formatNumber(row[8]));
        this.addPropertyRow(table, "Disk Reserved",    Format.formatNumber(row[9]));
        ...
        if (instance != null && instance.services != null)
        {
            ...
            for (var serviceIndex = 0; serviceIndex < instance.services.length; serviceIndex++)
            {
                ...
                else if (service.label != null)
                {
                    ...
                    // vendor, version and plan
                    Utilities.addEmptyElementsToArray(serviceRow, 3);
                }
                else
                {
