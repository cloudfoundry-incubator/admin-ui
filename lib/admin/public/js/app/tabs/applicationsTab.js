...
ApplicationsTab.prototype.showDetails = function(table, objects, row)
{
    ...
    this.addRowIfValue(this.addPropertyRow, table, "Buildpack", Format.formatString, row[13]);
    this.addFilterRowIfValue(table, "Buildpack GUID", Format.formatString, row[14], row[14], AdminUI.showBuildpacks);
