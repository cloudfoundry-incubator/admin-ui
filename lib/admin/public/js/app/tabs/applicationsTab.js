...
ApplicationsTab.prototype.initialize = function()
{
    ...
    this.applicationsEnvironmentVariablesTable = Table.createTable("ApplicationsEnvironmentVariables", this.getApplicationsEnvironmentVariablesColumns(), [[0, "asc"]], null, null, Constants.FILENAME__APPLICATION_ENVIRONMENT_VARIABLES, null, null);
};
