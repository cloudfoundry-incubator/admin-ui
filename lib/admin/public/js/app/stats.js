...
var Stats =
{
    ...
    updateStatsTableRow: function(row, item)
    {
        row.push(item.timestamp);
        row.push(item.organizations     || 0);
        row.push(item.spaces            || 0);
        row.push(item.users             || 0);
        row.push(item.apps              || 0);
        row.push(item.total_instances   || 0);
        row.push(item.running_instances || 0);
        row.push(item.deas              || 0);
    }
};
