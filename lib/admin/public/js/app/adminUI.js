...
var AdminUI =
{
    ...
    {
        AdminUI.tabs[Constants.ID__ORGANIZATIONS].showOrganizations(filter);
    },

    showQuota: function(quotaName)
    {
        AdminUI.tabs[Constants.ID__QUOTA_DEFINITIONS].showQuota(quotaName);
    },
    ...
    showServicePlan: function(servicePlanGUID)
    {
        AdminUI.tabs[Constants.ID__SERVICE_PLANS].showServicePlan(servicePlanGUID);
    },
