...
var AdminUI =
{
    ...
    showModalDialog: function(title, content, buttons)
    {
        ...
        if ((buttons != null) && (buttons.length > 0))
        {
            for (var index = 0; index < buttons.length; index++)
            {
                ...
                var modalDialogButton = $("<button " + 'id="modalDialogButton' + index + '" class="modalDialogButton">' + button.name + "</button>");
    ...
    {
        AdminUI.showModalDialogInformation("Error", text);
    },
    
    showModalDialogInformation: function(title, text)
    {
        AdminUI.showModalDialog(title, 
                                $("<label>" + text + "</label>"),
                                [
    ...
    {
        AdminUI.showModalDialogInformation("Success", 
