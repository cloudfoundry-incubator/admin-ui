...
var AdminUI =
{
    ...
    showModalDialog: function(title)
    {
        $('#ModalDialogDiv').css(
            {
                'display'    : 'block',
        ...
        $('#ModalDialogBackgroundDiv').css(
            {
                'display': 'block'
            }
        );
        $('#ModalDialogMessageDiv').width('280px');
        $('#ModalDialogMessageDiv')[0].innerHTML = title;
    },

    closeModalDialog: function()
    {
        $("#ModalDialogDiv").css({'display' : 'none'});
        $("#ModalDialogBackgroundDiv").css({'display' : 'none'});
    }
};
