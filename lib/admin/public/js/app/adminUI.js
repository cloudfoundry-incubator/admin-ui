...
var AdminUI =
{
    ...
    {
        AdminUI.showFiltered(Constants.ID__APPLICATIONS, filter);
    },
    ...
    {
        AdminUI.showFiltered(Constants.ID__DEAS, filter);
    },
    
    showDevelopers: function(filter)
    {
        AdminUI.showFiltered(Constants.ID__DEVELOPERS, filter);
    },
    ...
    showFiltered: function(id, filter)
    {
        AdminUI.setTabSelected(id);
        
        var tab = AdminUI.tabs[id];
        
        tab.hideDetails();

        tab.table.fnFilter(filter);
    ...
    {
        AdminUI.showFiltered(Constants.ID__ORGANIZATIONS, filter);
    },

    showQuotas: function(quotaName)
    {
        AdminUI.showFiltered(Constants.ID__QUOTA_DEFINITIONS, quotaName);
    },

    showRoutes: function(filter)
    {
        AdminUI.showFiltered(Constants.ID__ROUTES, filter);
    },

    showServiceInstances: function(filter)
    {
        AdminUI.showFiltered(Constants.ID__SERVICE_INSTANCES, filter);
    },

    showServicePlans: function(filter)
    {
        AdminUI.showFiltered(Constants.ID__SERVICE_PLANS, filter);
    },

    showSpaces: function(filter)
    {
        AdminUI.showFiltered(Constants.ID__SPACES, filter);
    },
