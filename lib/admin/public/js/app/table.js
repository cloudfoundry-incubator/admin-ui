var Table =
{
    ...
    getSelectableTableConfiguration: function(tableID, columns, initialSort, clickHandler, tableActions, filename, serverSideURL, afterServerDataCallback)
    {
        ...
        config.buttons.push({
                                extend:    "collection",
                                text:      "Save",
                                attr:      { id:              buttonIDPrefix + (buttonIndex + 2),  // TODO - assign ID's to button so we can test the buttons
                                             "aria-haspopup": true }, // TODO - need for collection button to autoClose in Buttons 1.5.6 since default button attr's are not merged.
                                autoClose: true,
                                buttons:
                                [
                                    {
