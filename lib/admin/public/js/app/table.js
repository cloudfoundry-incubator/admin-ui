var Table =
{
    ...
    getSelectableTableConfiguration: function(tableID, columns, initialSort, clickHandler, tableActions, filename, serverSideURL, afterServerDataCallback)
    {
        ...
        config.buttons.push({ extend: "copy", title: title, exportOptions: exportOptions });
        config.buttons.push({ extend: "print", title: title, exportOptions: exportOptions });
        ...
        config.buttons.push({
                                ...
                                "buttons":
                                [
                                    { extend: "csv",   filename: filename, title: title, exportOptions: exportOptions },
                                    { extend: "excel", filename: filename, title: title, exportOptions: exportOptions },
                                    { extend: "pdf",   filename: filename, title: title, exportOptions: exportOptions, orientation: "landscape" }
                                ]
                            });
