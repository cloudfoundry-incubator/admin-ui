...
var Table =
{
    ...
    getSelectableTableConfiguration: function(tableID, columns, initialSort, clickHandler, tableActions, serverSideURL, afterServerDataCallback)
    {
        ...
        {
            for (var index = 0; index < tableActions.length; index++)
            {
                var tableAction = tableActions[index];
    ...
    {
        AdminUI.showModalDialog("Download", $("<label>Performing operation, please wait...</label>"));
