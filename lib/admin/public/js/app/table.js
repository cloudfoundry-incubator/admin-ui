...
var Table =
{
    ...
    createTable: function(tableID, columns, initialSort, clickHandler)
    {
        var tableConfig = this.getSelectableTableConfiguration(initialSort, clickHandler);
    ...
    getSelectableTableConfiguration: function(initialSort, clickHandler)
    {
        var config = {
