...
var Table =
{
    ...
    {
        var tableConfig = this.getSelectableTableConfiguration(tableID, initialSort, clickHandler, tableActions, serverSideURL, afterServerDataCallback);
    ...
    getSelectableTableConfiguration: function(tableID, initialSort, clickHandler, tableActions, serverSideURL, afterServerDataCallback)
    {
        var config = {
